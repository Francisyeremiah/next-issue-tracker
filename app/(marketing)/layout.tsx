...
export default async function MarketingLayout({children}: {children: React.ReactNode}){
    return (
        <div className="flex min-h-screen flex-col">
            <header className="border-b border-gray-200 dark:border-dark-100 border-bg-white dark-bg-base-100">
            ...
            <footer className="border-t border-gray-200 dark:border-dark-100 bg-white dark:bg-dark-base-100">
                <div className="container mx-auto px-4 py-8">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div>
                            <h3 className="text-lg font-semibold mb-4">Mode</h3>
                            <p className="text-sm text-gray-600">
                                A Mordern Project Management Tool Built with Next.js.
                            </p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li>
                                    <a href="http://github.com/francisyeremiah/issue-tracker" target="_blank" rel="noopener noreferrer" className="text-sm text-gray-600 hover:text-purple-600">
                                        GitHub
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div className="mt-8 text-center border-t pt-8">
                        <p className="text-sm text-gray-600">
                            © <Timestamp /> Mode. Built for Microskills. All rights reserved.
                        </p>
                    </div>
                </div>
            </footer>
