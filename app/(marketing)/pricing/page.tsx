        ...
        <div className="container mx-auto px-4 py-12 text-white">
            ...
            >
                ...
                <PricingCard
                    title="Free"
                    price="$0 "
                    description="Perfect for individuals and small team getting started"
                    features={[
                ...
                <PricingCard
                    ...
                    description="For growing teams that needs more features and flexbility"
                    features={[
                ...
                <PricingCard
                    ...
                    features={[
                        ...
                        {name: 'API access', included: true},
                        {name: 'Custom fields', included: true},
                        {name: 'Advanced intergrations', included: true},
                    ]}
                    buttonText='Contact Sales'
                    buttonLink='mailto:sales@microskills.ac.tz'
                />
            </div>
